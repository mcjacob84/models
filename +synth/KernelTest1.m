classdef KernelTest1 < models.BaseFullModel & models.BaseDynSystem & dscomponents.CompwiseKernelCoreFun
...
function this = KernelTest1(dims, pos_flag)
            ...
            %% BaseCompWiseKernelApprox settings
            this.SystemKernel = kernels.GaussKernel(dims*100);
...
%             c = sum(abs(this.Ma(1,:))) * this.sk.getGlobalLipschitz(this.dim);
...
%     end
    ...
    methods(Static)
        ...
        function [r1,r2] = runEstimatorTest(testnum)
            ...
            r2.ErrorEstimator = error.GlobalLipKernelEstimator2(r2);
            r2.analyze;
        end
