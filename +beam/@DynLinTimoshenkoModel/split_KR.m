...
%              hold on ;
%             
%             plot3( p_new(P_end, 1), p_new(P_end, 2), p_new(P_end, 3), '-o', 'LineWidth', 2, 'Color', 'green'  );
%             plot3( p_new(P_start(1), 1), p_new(P_start(1), 2), p_new(P_start(1), 3), '-o', 'LineWidth', 2, 'Color', 'green'  );
%             plot3( p_new(P_start(2), 1), p_new(P_start(2), 2), p_new(P_start(2), 3), '-o', 'LineWidth', 2, 'Color', 'green'  );
%             
%             
%             
%             plot3( p_new(P_end, 1) + COR(1,:), p_new(P_end, 2) + COR(2,:), p_new(P_end, 3) + COR(3,:), '-+', 'LineWidth', 2, 'Color', 'black'  );
    ...
    for j = 1:KR_factor-1
         ...
         % p_new(size(p,1)+point_count,:)
         % 
          point_count = point_count+1;
          
           %  figure(4);
           % hold on ;
          %plot3( p_new(P_act, 1) , p_new(P_act, 2) , p_new(P_act, 3), '-+', 'LineWidth', 2, 'Color', 'black'  );
          %plot3( p_new(P_end, 1) , p_new(P_end, 2) , p_new(P_end, 3), '-+', 'LineWidth', 2, 'Color', 'black'  );
...
% for l=1:size(KR_raw_new,1)
%    hold on
%    figure(15);
%    x1= p_new(KR_raw_new(l,2),:);
%    x2= p_new(KR_raw_new(l,3),:);
%    
%    plot3(x1,x2);
%    
%    
