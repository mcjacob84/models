...
% - \c License @ref licensing
    ...
    methods(Static)
        function B = circle_connect_matrix(R, L)
            C0 = models.beam.CurvedBeam.circle_shape_functions(R, 0, eye(12));
            CL = models.beam.CurvedBeam.circle_shape_functions(R, L, eye(12));
            B = inv([C0; CL]);
        end
        
        function N = circle_shape_functions(R, s, B)
